...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      // AUTOMATIC LINKAGE ENGINE: If role is Restaurant, create its profile automatically
      if (_selectedRole == 'Restaurant') {
        DocumentReference restaurantRef = await FirebaseFirestore.instance
            .collection('restaurants')
            .add({
          'name': '${_nameController.text.trim()}\'s Kitchen',
          'image': '',
          'category': 'Fast Food',
        ...
        assignedRestaurantId = restaurantRef.id; // Extracting auto-generated doc string key
      }

      // Step 3 — Save all details to Firestore users collection automatically
      await FirebaseFirestore.instance
        ...
        'authProvider': 'email',
        'role':         _selectedRole,
        'restaurantId': assignedRestaurantId, // Embedded dynamically without manual setup console actions!
        'createdAt':    FieldValue.serverTimestamp(),
